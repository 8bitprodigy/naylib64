...
putEnv("N64_C_AND_CXX_FLAGS", "-march=vr4300 -mtune=vr4300 -I " & getEnv("N64_INCLUDEDIR") &
  " -Wall -D_GNU_SOURCE -Wno-missing-braces -Werror=pointer-arith" &
  " -falign-functions=32 -DGRAPHICS_API_OPENGL_11 -DPLATFORM_NINTENDO64" &
...
switch("passC", getEnv("N64_CXXFLAGS"))
switch("passL", "-g -L" & getEnv("N64_LIBDIR") & " -ldragon -lc -lm -ldragonsys -Tn64.ld --gc-sections --wrap __do_global_ctors -l:libraylib.a")
