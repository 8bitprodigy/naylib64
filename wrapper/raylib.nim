...
proc exportDataAsCodeImpl(data: ptr uint8, dataSize: int32, fileName: cstring): bool {.importc: "ExportDataAsCode", sideEffect.}
...
proc exportDataAsCode*(data: var uint8, dataSize: int32, fileName: string): bool =
  ## Export data to code (.h), returns true on success
  exportDataAsCodeImpl(addr data, dataSize, fileName.cstring)
...
proc loadImageSvg*(fileNameOrString: string, width: int32, height: int32): Image =
  ## Load image from SVG file data or string with specified size
  loadImageSvgImpl(fileNameOrString.cstring, width, height)
